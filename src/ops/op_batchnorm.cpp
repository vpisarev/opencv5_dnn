...
public:
    ...
    virtual int supportBlockLayout(int input, int) const CV_OVERRIDE
    {
        // [TODO] this is a little hack, but since all parameters except for 0th one must be scalars, we always report 0
        return input == 0 ? 1 : -1;
    }
